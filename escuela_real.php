...
<head>
   ...
   <script src="crud_escuela_real/escuela_real.js" type="text/javascript"></script>
  ...
  <nav class="#01579b light-blue darken-4">
    ...
    <div class="row escritorio" >
      ...
      <div class="col l12 m12 s12">
        <h3 id="titulo" style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">Real</h3>
      </div>
