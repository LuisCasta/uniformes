...
<head>
   ...
   <script src="crud_escuela_entrega/escuela_entrega.js" type="text/javascript"></script>
...
<body class="#eceff1 blue-grey lighten-4">
    ...
    <div class="row escritorio" >
      <div class="col l12 m12 s12">
        <h3 style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">Entregas Realizadas</h3>
      </div>
