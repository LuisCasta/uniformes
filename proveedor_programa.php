...
<head>
   ...
   <script src="crud_proveedor_programa/proveedor_programa.js" type="text/javascript"></script>
...
<body class="#eceff1 blue-grey lighten-4">
    ...
    <div class="row escritorio" >
      <div class="col l12 m12 s12">
        <h3 style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">Alta de programas</h3>
      </div>
      <div class="col l12 m12 s12">
        <label>Usted puede registrar un nuevo programa(año)</label><br><br>
      </div>
    <div class='col l6 m12 s12'>
		<label>Programa</label>
		<input type='number' id='input_ciclo'>
		</div>
		<div class="col l12 m12 s12">
		<a id="boton_registrar" class="btn green waves-effect waves-light" style="border-radius: 10px;"><i class="material-icons right">exit_to_app</i>Registrar</a>
		</div>
    </div>        
</body>
<style type="text/css">
