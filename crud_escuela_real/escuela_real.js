...
var ciclo =	$('#selector_ciclo').val();
	$.ajax
	({
	   url: 'crud_escuela_real/consulta_etapas.php',
	   data: {"ciclo":ciclo},
	   type: 'post',
...
if(etapa == "seleccione")
	...
	swal({
		...
		var t10 = $('#10').val(); 
			$.ajax
			({
			   url: 'crud_escuela_real/insertarpre.php',
			   data: {"tipo":tipo,"etapa":etapa,"grado":grado,"total":total,"ciclo":ciclo,"t3":t3,"t4":t4,"t5":t5,"t6":t6,"t8":t8,"t10":t10},
			   type: 'post',
			   success: function(result){		   	
			   	if(result == "exito")
		...
		var t24 = $('#24').val(); 
			$.ajax
			({
			   url: 'crud_escuela_real/insertarpri.php',
			   data: {"tipo":tipo,"etapa":etapa,"grado":grado,"total":total,"ciclo":ciclo,"t5":t5,"t6":t6,"t8":t8,"t10":t10,"t12":t12,"t14":t14,"t16":t16,"t18":t18,"t20":t20,"t22":t22,"t24":t24},
			   type: 'post',
			   success: function(result){		   	
			   	if(result == "exito")
				            swal("Hecho", result, "success");
		...
		var t26 = $('#26').val(); 
			$.ajax
			({
			   url: 'crud_escuela_real/insertarsec.php',
			   data: {"tipo":tipo,"etapa":etapa,"grado":grado,"total":total,"ciclo":ciclo,"t12":t12,"t14":t14,"t16":t16,"t18":t18,"t20":t20,"t22":t22,"t24":t24,"t26":t26},
			   type: 'post',
			   success: function(result){		  
			   	if(result == "exito")
				            swal("Hecho", result, "success");
