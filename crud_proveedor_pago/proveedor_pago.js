...
var id_proveedor = $("#select_proveedor").val();
var id_taller = $("#select_id_taller").val();
var id_ciclo = $("#select_id_programa").val();
var monto = $("#input_monto").val();
if(fecha == "")
M.toast({html:"Introducir  fecha"});
else if(id_proveedor == "seleccione")
M.toast({html:"Introducir  proveedor"});
else if(id_taller == "seleccione")
...
$.ajax
({
url: "crud_proveedor_pago/insertar.php",
data: {"fecha":fecha,"id_proveedor":id_proveedor,"id_taller":id_taller,"id_ciclo":id_ciclo,"monto":monto},
type: "post",
...
var ciclo =	$('#select_id_programa').val();
	$.ajax
	({
	   url: 'crud_proveedor_pago/consulta_talleres.php',
	   data: {"ciclo":ciclo},
	   type: 'post',
	   success: function(result){	
	   $('#select_id_taller').html(result);   	
	   }	
	});
});
