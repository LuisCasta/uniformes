...
<head>
   ...
   <script src="crud_taller_reporte/taller_reporte.js" type="text/javascript"></script>
   <meta charset="utf-8">
...
<body class="#eceff1 blue-grey lighten-4">
    ...
    <div class="row escritorio" >
      <div class="col l4 m12 s12">
        ...
        <option value="pedido" selected>Normal</option>
        <option value="extra">Extra</option>
        </select>
      </div>
      <div class="col l12 m12 s12">
        <h3 id="titulo" style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">Reporte</h3>
      </div>
      ...
      <div class="collection col l12 m12 s12" style="margin-top: 20px">
      <div id="total_etapa" class=' col l12 m12 s12'></div>
      <div id="cruze" class=' col l4 m12 s12'></div>
      <div id="total" class=' col l12 m12 s12'></div>
      <div class="col l12 m12 s12">
        <table>
        <thead>
          <tr id="encabezado">              
      ...
      <div id="total_real" class=' col l12 m12 s12'></div>
      <div class="col l12 m12 s12">
        <table>
        <thead>
          <tr id="encabezado_real">              
          </tr>
        </thead>
        <tbody>
          <tr id="renglon_real">        
