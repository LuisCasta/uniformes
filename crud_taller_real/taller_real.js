...
$('#selector_pedido').html("");  
if(tipo == "pedido"){
	$('#titulo').text("Real");
}
else if(tipo == "extra"){
	$('#titulo').text("Real Extra");
}
});
...
var ciclo =	$('#selector_ciclo').val();
	$.ajax
	({
	   url: 'crud_taller_real/consulta_etapas.php',
	   data: {"ciclo":ciclo},
	   type: 'post',
...
if(ciclo == "seleccione")
...
else if(etapa == "seleccione"||etapa == ""||etapa == null)
	...
	var t10 = $('#10').val(); 
		$.ajax
		({
		   url: 'crud_taller_real/insertarpre.php',
		   data: {"ciclo":ciclo,"etapa":etapa,"nivel":nivel,"tipo":tipo,"t3":t3,"t4":t4,"t5":t5,"t6":t6,"t8":t8,"t10":t10},
		   type: 'post',
		   success: function(result){	   	
			   	if(result == "exito")
	...
	var t24 = $('#24').val(); 
		$.ajax
		({
		   url: 'crud_taller_real/insertarpri.php',
		   data: {"ciclo":ciclo,"etapa":etapa,"nivel":nivel,"tipo":tipo,"t5":t5,"t6":t6,"t8":t8,"t10":t10,"t12":t12,"t14":t14,"t16":t16,"t18":t18,"t20":t20,"t22":t22,"t24":t24},
		   type: 'post',
		   success: function(result){		   	
			   	if(result == "exito")
			            swal("Hecho", result, "success");
	...
	var t26 = $('#26').val(); 
		$.ajax
		({
		   url: 'crud_taller_real/insertarsec.php',
		   data: {"ciclo":ciclo,"etapa":etapa,"nivel":nivel,"tipo":tipo,"t12":t12,"t14":t14,"t16":t16,"t18":t18,"t20":t20,"t22":t22,"t24":t24,"t26":t26},
		   type: 'post',
		   success: function(result){	
			   	if(result == "exito")
			            swal("Hecho", result, "success");
