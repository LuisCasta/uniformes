...
<head>
   ...
   <script src="crud_proveedor_vigencia/proveedor_vigencia.js" type="text/javascript"></script>
...
<body class="#eceff1 blue-grey lighten-4">
    ...
    <div class="row escritorio" >
      <div class="col l12 m12 s12">
        <h3 style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">Vigencia De Proveedores</h3>
      </div>
      <div class='col l6 m12 s12'>
  	  <select class="browser-default red white-text"id="selector_id_proveedor" style="border-radius: 20px">
      <option value="seleccione" selected>Seleccione un proveedor</option>       
      <?php 
