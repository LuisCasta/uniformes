...
<body class="#eceff1 blue-grey lighten-4">
    ...
    <div class="row escritorio" >
      <div class="col l12 m12 s12">
        <h3 style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">Catálogo de escuelas</h3>
      </div>
      <div class="col l12 m12 s12">
        <label>Usted puede visualizar, las escuelas dadas de alta en el sistema.</label><br><br>
      </div>
      <div class="col l12 m12 s12">
        <table>
        <thead>
      ...
      <div class="col l6 m12 s12" style="margin-top: 2em">
        <a id="descargar" class="green waves-effect waves-light btn" href="escuela_excel.php"><i class="material-icons right">folder</i>Descargar Lista</a>
      </div>
    </div>        
</body>
<style type="text/css">
